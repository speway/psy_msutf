          ...
          return (
            ...
            >
              <div className="flex items-start gap-4">
                {Icon && (
                  <div className="w-10 h-10 flex items-center justify-center border-2 border-bauhaus-ochre/30 text-bauhaus-ochre shrink-0 group-hover:bg-accent group-hover:text-accent-foreground transition-colors">
